...
const ORDER_TABLE = 'Order-cklxe53im5ed5mke55ccze2u7i-dev';
const ORDER_TYPE = 'Order';
const BOOK_ORDER_TABLE = 'ProductOrder-cklxe53im5ed5mke55ccze2u7i-dev';
...
const createBookOrder = async (payload) => {
	...
	params['RequestItems'][BOOK_ORDER_TABLE] = productOrders;
	console.log(params);
